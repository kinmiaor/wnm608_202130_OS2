...
<body>
   ...
   <div class="container display-flex flex-justify-center hide">
    <p>We believe in healthy skin. To us that means listening to its cravings. Your skin will tell you what it need, and we'll tell you what works.</p>
   </div>
 
   <div class="containerbutton display-flex flex-justify-center button-shrink">
   <a href="product_list.php" class="bigbutton hide">SHOP NOW</a>
   </div>
  ...
  <div class="container display-flex flex-justify-center hide">
   ...
   <!-- <div class="containerwide grid-justify-around hide" style="margin-top: 1em">
    <div class="grid">
      ...
      <a href="#" class="button col-sm-12 col-md-2">VIEW MORE</a>
   ...
   <!--  <div class="container display-flex flex-space-around" style="margin-top: 1em">
    ...
    <div class="view-window1 display-flex flex-align-center flex-justify-center" style="background-image:url(img/ad3.jpg)">
